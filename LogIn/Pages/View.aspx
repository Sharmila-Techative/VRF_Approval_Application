<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="LogIn.Pages.View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        function validateRemarks() {
            var remarks = document.getElementById('<%= txtRemarksPage.ClientID %>').value.trim();
...
<i class="fas fa-download"></i>
                ...
                <asp:GridView ID="gvOperationalContacts" runat="server" AutoGenerateColumns="false" CssClass="table table-responsive" ShowHeaderWhenEmpty="true" OnRowDataBound="gvOperationalContacts_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Email-ID" HeaderStyle-CssClass="center-header">
                            <ItemTemplate>
                                <asp:TextBox ID="pocEmail" runat="server" TextMode="Email" Style="width: 340px; border-top: none; border-left: none; border-right: none" ReadOnly="true"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
            ...
            <div style="overflow: auto; overflow-x: hidden;">
                <asp:GridView ID="gvMajorGoods" runat="server" AutoGenerateColumns="false" CssClass="table table-responsive" ShowHeaderWhenEmpty="true" OnRowDataBound="gvMajorGoods_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Material Description" HeaderStyle-CssClass="center-header" Visible="false">
                            <ItemTemplate>
                                <asp:TextBox ID="txtMaterialDescription" runat="server" Style="width: 140px; border-top: none; border-left: none; border-right: none" Visible="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="HSN Code" HeaderStyle-CssClass="center-header" Visible="false">
                            <ItemTemplate>
                                <asp:TextBox ID="txtHSNCode" runat="server" Style="width: 100px; border-top: none; border-left: none; border-right: none" Visible="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Tax %" HeaderStyle-CssClass="center-header" Visible="false">
                            <ItemTemplate>
                                <asp:TextBox ID="txtTaxPercentage" runat="server" TextMode="Number" Style="width: 90px; border-top: none; border-left: none; border-right: none;" ReadOnly="true" Visible="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
    ...
    <asp:Panel ID="pnlPage9" runat="server" Visible="false">
    ...
    <asp:Panel ID="pnlApprovalButtons" runat="server" Style="margin-left: 18px; margin-bottom: auto" Visible="false">
        <asp:Button ID="Approve" runat="server" Text="Approve"
            ...
            Style="padding: 5px; border-radius: 3px; background-color: green; color: white; border: none; cursor: pointer;"
        ...
        <asp:Button ID="btnDraftApproved" runat="server" Text="Approve"
            ...
            OnClick="DraftApproved" OnClientClick="showLoader(this); return false;"
    ...
    <div id="BankDetailspopup" class="custom-popup" style="display: none;">
        <div class="custom-popup-content modern-popup">
            ...
            <div class="custom-popup-body">
                <!-- Reason TextBox -->
                <asp:TextBox ID="popuptext" runat="server" CssClass="popup-textbox" placeholder="Enter your reason here">
                </asp:TextBox>
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlGstRecreate" runat="server" CssClass="popup-dropdown">
                ...
                <div class="popup-actions">
                    <asp:Button ID="SubmitButton1" runat="server" CssClass="popup-btn" OnClick="SubmitButton_Click" Text="OK" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnSubmitApprovalPage" runat="server" Text="Submit"
                        CssClass="btn btn-success" OnClick="ApproveVendor" OnClientClick="return validateRemarks();" />
